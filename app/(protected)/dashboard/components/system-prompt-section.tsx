// Komponen System Prompt Section untuk dashboard
"use client";
      ...
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Choose an agent from the sidebar to edit its system prompt
          </p>
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Define how your agent should behave and respond to messages. This
            prompt will guide the AI&apos;s personality, tone, and capabilities.
          </CardDescription>
        </CardHeader>
